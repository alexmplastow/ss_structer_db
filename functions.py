...
def transcript_folding(sample_size, transcript_dict, nucleic_acid_length, RNAStructure_boolean, inTandem_boolean):
    ...
    for transcript, index in enumerate(transcripts):
        if transcript in keys:
