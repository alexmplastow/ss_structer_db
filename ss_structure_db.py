...
def main():
    ...
    parser.add_argument('-o', '--output', help='Folded output file', type=str, nargs = '?', default = 'structure.csv',
                        const = 'structure.csv')
    ...
    if args.calibrate:
        functions.calibration_folding(transcript_dict, args.calibrate,
                                      ...
                                      args.calibration_output, args.fast_fold_time, args.output)
    ...
    if not args.calibrate and args.fold_transcriptome:
        functions.transcript_folding(args.sample_size, transcript_dict, args.nucleic_acid_length,
                                     args.RNAStructure, args.inTandem, args.output)
